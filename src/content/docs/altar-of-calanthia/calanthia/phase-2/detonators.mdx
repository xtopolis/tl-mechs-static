...
<YouTubeEmbed videoId="_js-wrZunx8" />
...
<Image src="/images/altar-of-calanthia/calanthia/detonator-doors.png" width={519} height={388} alt="Detonator door locations" class="mech-diagram" />

_Example of stacking detonation circles around the miniboss_
<Image src="/images/altar-of-calanthia/calanthia/detonator-circles.png" width={804} height={609} alt="Detonator circle patterns" class="mech-diagram" />

_Diagram of possible miniboss swarming arrangements: Cardinal directions, and 2 player stacking_
<Image src="/images/altar-of-calanthia/calanthia/phase2-detonators.png" width={656} height={1108} alt="Orbs pattern diagram" class="mech-diagram" />
